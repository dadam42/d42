...
/*   Updated: 2020/04/23 19:20:18 by damouyal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	array_collection_add_in_removed(t_array_collection *array_collection
									, void *element)
{
		*((void **)stack_peek(array_collection->initer.removed)) = element;
		stack_pop(array_collection->initer.removed);
...
bool	array_collection_add(t_array_collection *array_collection
									, void	*element)
{
	if (stack_size(array_collection->initer.removed) > 0)
