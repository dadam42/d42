...
/*   Updated: 2020/04/23 05:43:26 by damouyal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
											...
											, t_iterator *iterator)
{
	...
	iterator->next = dyn_array_iterator_next_as_iterator;
	iterator->deref = dyn_array_iterator_deref_as_iterator;
	iterator->release = iterator_noop_release;
	iterator->reached_end = dyn_array_iterator_reached_end_as_iterator;
}
